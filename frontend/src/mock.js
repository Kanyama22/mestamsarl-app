// Mock data for Mestamsarl application
...
export const testimonials = [
  {
    ...
    name: 'Jean Kabongo',
    location: 'Kinshasa',
    comment: 'Excellent service! Mes machines sont arrivées en parfait état. Je recommande vivement Mestam SARL.',
    rating: 5
  },
  {
    id: 2,
    ...
    location: 'Lubumbashi',
    comment: 'Très professionnel, livraison rapide et produits de qualité. Merci!',
    rating: 5
  },
  {
    id: 3,
    name: 'Patrick Mwamba',
    location: 'Kolwezi',
    comment: 'Prix compétitifs et service client réactif. Une très bonne expérience.',
    rating: 4
  }
];
...
export const companyInfo = {
  name: 'MESTAM SARL',
  rccm: 'CD/LSH/RCCM/23-B-01970',
  idNat: '05-H5300-N33537R',
  nImpot: 'A2325669C',
  email: 'contact@mestamsarl.com',
  phone: '+243 XX XXX XXXX',
  address: 'Kinshasa, République Démocratique du Congo',
  cities: ['Kinshasa', 'Lubumbashi', 'Kolwezi']
};
